...
import {
    ArrowLeft, TrendingUp, Calendar, Clock,
    MoreVertical, Search, Filter, Trash2
} from 'lucide-react';
        ...
        <div className="min-h-screen bg-[#f8fafc] pb-24">
            ...
            <header className="bg-white px-6 py-8 border-b border-slate-100 sticky top-0 z-30">
                <div className="flex items-center gap-4 mb-6">
                    ...
                    <h1 className="text-xl font-bold text-slate-900">Income Ledger</h1>
                </div>
                ...
                <div className="flex gap-4">
                    <div className="flex-1 relative">
                        <input
                            ...
                            className="w-full p-4 pl-12 bg-slate-50 border-none rounded-2xl text-sm font-bold text-slate-700 placeholder:text-slate-300 focus:ring-2 focus:ring-emerald-500/20"
                        />
                ...
                <div className="space-y-4">
                    {incomeTransactions.length === 0 ? (
                        <div className="text-center py-20">
                            <div className="w-20 h-20 bg-emerald-50 rounded-full flex items-center justify-center text-emerald-500 mx-auto mb-6 opacity-50">
                                <TrendingUp size={40} />
                            </div>
                            <h3 className="text-lg font-bold text-slate-400">No income records yet</h3>
                            <p className="text-sm text-slate-300 mt-2">Save a calculation as income to see it here.</p>
                        </div>
                    ) : (
                        incomeTransactions.map((item, idx) => (
                            ...
                            >
                                ...
                                <div className="text-right">
                                    <div className="text-lg font-bold text-emerald-600">रु {item.total.toLocaleString()}</div>
                                    <button
